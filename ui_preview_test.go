...
func TestLocalUIPreview(t *testing.T) {
	...
	r.GET("/admin", func(c *gin.Context) {
		c.HTML(200, "admin.html", gin.H{"Title": "Панель администратора", "User": actor, "Summary": adminSnapshot{Questions: 12, Users: 9, ActiveRounds: 4, Files: 28}, "Materials": []adminMaterial{{ID: 12, Title: "Бюджет концертного сезона", Status: "Внутреннее согласование"}, {ID: 11, Title: "Договор на поставку оборудования", Status: "Голосование Комитета"}}})
	})
